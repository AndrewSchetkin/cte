...
$APPLICATION->SetTitle("Документы для выпускников");
?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "graduate_documents", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"COMPONENT_TEMPLATE" => "about_documents"
	),
	false
);?>
